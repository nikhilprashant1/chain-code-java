...
public final class Asset {
    ...
    public int  getDataRecord() {return dataRecord;}
    ...
    public Asset(@JsonProperty("assetID") final String assetID, @JsonProperty("color") final String color,
            ...
            @JsonProperty("appraisedValue") final int appraisedValue, @JsonProperty("dataRecord") final int dataRecord) {
    ...
    public String toString() {
        return this.getClass().getSimpleName() + "@" + Integer.toHexString(hashCode()) + " [assetID=" + assetID + ", color="
                + color + ", size=" + size + ", owner=" + owner + ", appraisedValue=" + appraisedValue + ", dataRecord" + dataRecord + "]";
    }
}
