...
public final class AssetTransfer implements ContractInterface {
    ...
    public void InitLedger(final Context ctx) {
        ...
        CreateAsset(ctx, "asset1", "blue", 5, "Tomoko Japan", 300, 1);
        CreateAsset(ctx, "asset2", "red", 5, "Brad", 400, 1);
        CreateAsset(ctx, "asset3", "green", 10, "Jin Soo", 500, 1);
        CreateAsset(ctx, "asset4", "yellow", 10, "Max", 600, 1);
        CreateAsset(ctx, "asset5", "black", 15, "Adrian", 700, 1);
        CreateAsset(ctx, "asset6", "white", 15, "Michel", 700, 1);
    ...
    public Asset CreateAsset(final Context ctx, final String assetID, final String color, final int size,
        final String owner, final int appraisedValue, final int dataRecord) {
        ChaincodeStub stub = ctx.getStub();
        ...
        Asset asset = new Asset(assetID, color, size, owner, appraisedValue, dataRecord);
    ...
    public Asset UpdateAsset(final Context ctx, final String assetID, final String color, final int size,
        ...
        Asset newAsset = new Asset(assetID, color, size, owner, appraisedValue, dataRecord);
        // Use Genson to convert the Asset into string, sort it alphabetically and serialize it into a json string
    ...
    public String TransferAsset(final Context ctx, final String assetID, final String newOwner) {
        ...
        Asset newAsset = new Asset(asset.getAssetID(), asset.getColor(), asset.getSize(), newOwner, asset.getAppraisedValue(), asset.getDataRecord());
